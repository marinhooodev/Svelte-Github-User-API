...
<div class="card-usuario">
  ...
  <div class="usuario">
    ...
    <div class="detalhes-usuario">
      {#if usuario.nome}
        <div class="info">Nome: <span>{usuario.nome} </span></div>
      {/if}
      <div class="info">Usuário: <span>{usuario.login} </span></div>
      <div class="info">Seguidores: <span>{usuario.seguidores} </span></div>
      <div class="info">
    ...
    {#if temRepositorios}
      <div class="repositorios">
        ...
        <ul>
          {#each usuario.repositorios_recentes as repositorio, index}
            <li>
